...
"aceite_caja",trabajoGui.getAceiteCaja().isSelected(),
"aceite_diferencial",trabajoGui.getAceiteDif().isSelected(),
"filtro_aire",trabajoGui.getFiltroAire().isSelected(),
"filtro_combustible",trabajoGui.getFiltroCombustible().isSelected(),
"filtro_aceite",trabajoGui.getFiltroAceite().isSelected(),
"filtro_habitaculo",trabajoGui.getFiltroHabitaculo().isSelected(),
"liquido_freno",trabajoGui.getLiquidoFreno().isSelected(),
"anticongelante",trabajoGui.getAnticongelante().isSelected(),
"correa_multicanal",trabajoGui.getCorreaMulticanal().isSelected(),
"tensor_correa_multicanal",trabajoGui.getTensorMulticanal().isSelected(),
"correa_distribucion",trabajoGui.getCorreaDistrib().isSelected(),
"tensores",trabajoGui.getTensores().isSelected(),
"bomba_agua",trabajoGui.getBombaAgua().isSelected(),

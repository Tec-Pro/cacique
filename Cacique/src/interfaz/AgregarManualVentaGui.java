 ...
 * @author nico
 */
public class AgregarManualVentaGui extends javax.swing.JDialog {
    private ControladorVenta control;

    /**
     * Creates new form AgregarManualPresGui
     */
    public AgregarManualVentaGui(java.awt.Frame parent, boolean modal,ControladorVenta control) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        control.ventaGui.getTablaFacturaDefault().addRow(cols);

 ...
 * @author nico
 */
public class AgregarManualPresGui extends javax.swing.JDialog {
    private ControladorPresupuesto control;

    /**
     * Creates new form AgregarManualPresGui
     */
    public AgregarManualPresGui(java.awt.Frame parent, boolean modal,ControladorPresupuesto control) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        control.PresupuestoGui.getTablaFacturaDefault().addRow(cols);
